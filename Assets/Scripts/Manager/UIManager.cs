...
public class UIManager : MonoBehaviour
{
    ...
    public void SetOption(int argNum)
    {
        ...
        if (argNum == 1)//자기소개
        {
            ...
            m_OptionDayText.text = (21 - GameValueManager.Instance.IsDate).ToString() + "일 남음";
            m_OptionDebtText.text = "현재채무 : " + GameValueManager.Instance.IsDebt;

            m_ParkRateText.text = "B.B랜드 평판: " + 
                Mathf.RoundToInt(ParkReputationManager.Instance.parkReputation / 100).ToString("00") + " 등급";
